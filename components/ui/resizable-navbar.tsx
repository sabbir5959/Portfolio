...
export const Navbar = ({ children, className }: NavbarProps) => {
  ...
  useMotionValueEvent(scrollYProgress, "change", (current) => {
    if (typeof current === "number") {
      ...
      if (scrollYProgress.get() < 0.05) {
        ...
        setVisible(direction < 0); // show on scroll up
      }
    }
  });
  ...
  return (
    <motion.div
      ...
      className={cn(
        "fixed inset-x-0 top-5 z-[5000] mx-auto w-full", // you can tweak top, width, etc.
        className
      )}
    >
...
type NavbarButtonProps<T extends React.ElementType> = {
  as?: T;
  href?: T extends "a" ? string : undefined;
  children: React.ReactNode;
  className?: string;
  variant?: "primary" | "secondary" | "dark" | "gradient";
} & Omit<React.ComponentPropsWithoutRef<T>, "children" | "className" | "href">;
